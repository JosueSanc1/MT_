...
import { ScrollView, View, Alert,StyleSheet, Text, Image } from 'react-native';
import { TextInput, Button, Appbar, Card, Title, Divider, Menu} from 'react-native-paper';
...
const ReporteDesechos = () => {
  ...
  const handleGeneratePDF = async () => {
    ...
    const fileName = `ReporteDesechos_${area}_${formattedDate}`;
...
<body>
        ...
        ${Array.from({ length: maxRows }).map((_, index) => {
            ...
            return `
                <div class="row">
                    ...
                    <div class="evaluation">
                      <div class="evaluation-items">
                        <div class="evaluation-item">${evaluation.suficientes ? evaluation.suficientes + '%' : ''}</div>
                        <div class="evaluation-item">${evaluation.rotulados ? evaluation.rotulados + '%' : ''}</div>
                        <div class="evaluation-item">${evaluation.tapados ? evaluation.tapados + '%' : ''}</div>
                        <div class="evaluation-item">${evaluation.limpios ? evaluation.limpios + '%' : ''}</div>
                        <div class="evaluation-item">${evaluation.ordenados ? evaluation.ordenados + '%' : ''}</div>
                        <div class="evaluation-item">${evaluation.recoleccionFrecuente ? evaluation.recoleccionFrecuente + '%' : ''}</div>
                      </div>
                    </div>
                    <div class="classification">
                      <div class="classification-items">
                        <div class="classification-item">${evaluation.carton ? evaluation.carton + '%' : ''}</div>
                        <div class="classification-item">${evaluation.plasticos ? evaluation.plasticos + '%' : ''}</div>
                        <div class="classification-item">${evaluation.metales ? evaluation.metales + '%' : ''}</div>
                        <div class="classification-item">${evaluation.organicos ? evaluation.organicos + '%' : ''}</div>
                        <div class="classification-item">${evaluation.electronicos ? evaluation.electronicos + '%' : ''}</div>
                        <div class="classification-item">${evaluation.inorganicos ? evaluation.inorganicos + '%' : ''}</div>
                      </div>
                    </div>
    ...
    try {
      ...
      const destinationPath = `${informesDir}/ReporteDesechos_${Proceso}_${formattedDate}.pdf`;
