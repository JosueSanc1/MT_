...
export default function MenuScreen({ navigation }) {
  ...
  const menuItems = [
    ...
    { text: 'Crear Reporte', imageSource: require('../../src/img/reporte.png'), screenName: 'Crear Informes' },
    { text: 'Reportes', imageSource: require('../../src/img/listaReporte.png'), screenName: 'Informes' },
  ...
  return (
    <View style={styles.container}>
      ...
      <Text> </Text>
      <Text style={styles.header}>Menu de Reportes de Inspeccion</Text>
