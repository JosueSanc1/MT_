...
import { Text, TextInput, Button, Appbar, Card, Title, Divider } from 'react-native-paper';
  ...
  return (
    <>
      ...
      <ScrollView contentContainerStyle={{ padding: 20 }}>
        ...
        <Card style={{ marginBottom: 20 }}>
          <Card.Content>
            ...
            <TextInput
              ...
              onChangeText={(value) => handleInputChange('suficientes', value)}
            ...
            <TextInput
              ...
              onChangeText={(value) => handleInputChange('rotulados', value)}
              keyboardType="numeric"
              style={{ marginBottom: 10 }}
              mode="outlined"
            />
            <TextInput
              ...
              onChangeText={(value) => handleInputChange('tapados', value)}
              keyboardType="numeric"
              style={{ marginBottom: 10 }}
              mode="outlined"
            />
            <TextInput
              ...
              onChangeText={(value) => handleInputChange('limpios', value)}
              keyboardType="numeric"
              style={{ marginBottom: 10 }}
              mode="outlined"
            />
            <TextInput
              ...
              onChangeText={(value) => handleInputChange('ordenados', value)}
              keyboardType="numeric"
              style={{ marginBottom: 10 }}
              mode="outlined"
            />
            <TextInput
              ...
              onChangeText={(value) => handleInputChange('recoleccionFrecuente', value)}
              keyboardType="numeric"
              style={{ marginBottom: 10 }}
              mode="outlined"
            />
            <TextInput
              ...
              onChangeText={(value) => handleInputChange('carton', value)}
              keyboardType="numeric"
              style={{ marginBottom: 10 }}
              mode="outlined"
            />
            <TextInput
              ...
              onChangeText={(value) => handleInputChange('plasticos', value)}
              keyboardType="numeric"
              style={{ marginBottom: 10 }}
              mode="outlined"
            />
            <TextInput
              ...
              onChangeText={(value) => handleInputChange('metales', value)}
              keyboardType="numeric"
              style={{ marginBottom: 10 }}
              mode="outlined"
            />
            <TextInput
              ...
              onChangeText={(value) => handleInputChange('organicos', value)}
              keyboardType="numeric"
              style={{ marginBottom: 10 }}
              mode="outlined"
            />
            <TextInput
              ...
              onChangeText={(value) => handleInputChange('electronicos', value)}
              keyboardType="numeric"
              style={{ marginBottom: 10 }}
              mode="outlined"
            />
            <TextInput
              ...
              onChangeText={(value) => handleInputChange('inorganicos', value)}
              keyboardType="numeric"
              style={{ marginBottom: 10 }}
              mode="outlined"
            />
        ...
        <Button mode="contained" onPress={handleAddRow} style={{ marginBottom: 20, backgroundColor: INSTITUTIONAL_GREEN }}>
          Guardar Fila
        </Button>
        <Button mode="contained" onPress={handleGeneratePDF} style={{ backgroundColor: INSTITUTIONAL_GREEN }}>
          Generar PDF
        </Button>
      </ScrollView>
      {showDatePicker && (
